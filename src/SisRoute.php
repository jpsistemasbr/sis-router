...
use SisRoute\Container\SettingRouteContainer;
use SisRoute\Container\RouteContainer;
...
class SisRoute
{
    ...
    public function middleware(string ...$middleware): SisRoute
    {
        $this->settingRouteContainer->addMiddleware(...$middleware);
        return $this;
    }

    public function namespace(string ...$namespace): SisRoute
    {
        $this->settingRouteContainer->addNamespace(...$namespace);
        return $this;
    }

    public function prefix(string ...$prefix): SisRoute
    {
    ...
    public function match(string $route, string ...$types): SisRoute
    {
        $this->settingRouteContainer->addMatchType($route, ...$types);
        return $this;
    }

    public function any(string $route): SisRoute
    {
